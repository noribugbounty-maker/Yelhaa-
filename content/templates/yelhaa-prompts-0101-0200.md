# Yelhaa Generated Prompt Templates 0101–0200

TEMPLATE 101 — Swiss Brutalist Monochrome — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Code Demo / Terminal
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to API gateway / developer infrastructure product -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via Framer Motion for chrome.

### 4. Architecture Diagram
- A labeled system diagram (SVG, hand-built nodes and edges, not a screenshot) showing the API gateway / developer infrastructure product's core data flow.
- Edges draw in via stroke-dashoffset 1->0 on scroll; nodes fade+scale in staggered by 60ms.
- Every node label ties to real supplied content ({{ITEM_1..6}}) -- no placeholder box labeled "Component".

### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
...
- Regulatory/legal entity line rendered here for devtool if applicable ({{ENTITY_LEGAL}}).
...
- No generic startup-template layout — this must read as a purpose-built API gateway / developer infrastructure product product, not a page-builder output.
...
TEMPLATE 102 — Aurora Glassmorphism — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Code Demo / Terminal
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to API gateway / developer infrastructure product -- built in SvelteKit 2 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via Svelte native transitions/motion stores.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 103 — Neo-Brutalist Pop — Api Gateway / Developer Infrastructure Product
...
### 3. Code Demo / Terminal
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to API gateway / developer infrastructure product -- built in Astro 4 with islands state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via GSAP.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 104 — Editorial Serif Luxury — Api Gateway / Developer Infrastructure Product
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 105 — Dark Technical Console — Api Gateway / Developer Infrastructure Product
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 106 — Cyberpunk Neon — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 107 — Industrial Utilitarian — Api Gateway / Developer Infrastructure Product
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 108 — Futuristic Chrome — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 109 — Soft Minimal Warmth — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 110 — Art Deco Revival — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 111 — Japanese Minimal (Ma) — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 112 — Scandinavian Functional — Api Gateway / Developer Infrastructure Product
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 113 — Retro-Futurist 80s — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 114 — Y2K Cyber-Cute — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 115 — Digital Laboratory — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 116 — Terminal-Inspired CLI — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 117 — Financial Terminal Dense — Api Gateway / Developer Infrastructure Product
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 118 — Magazine Grid — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 119 — High-Fashion Editorial — Api Gateway / Developer Infrastructure Product
...
TEMPLATE 120 — Architectural Blueprint — Api Gateway / Developer Infrastructure Product
...
TEMPLATE 121 — Experimental Typography — Api Gateway / Developer Infrastructure Product
...
TEMPLATE 122 — Data-Dense Analytics — Api Gateway / Developer Infrastructure Product
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 123 — Corporate Premium Trust — Api Gateway / Developer Infrastructure Product
...
TEMPLATE 124 — Playful Sophisticated — Api Gateway / Developer Infrastructure Product
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 125 — Organic Earth — Api Gateway / Developer Infrastructure Product

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a API gateway / developer infrastructure product ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (infrastructure features), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 126 — Swiss Brutalist Monochrome — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to cybersecurity threat-detection platform -- built in SolidStart state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Swiss Brutalist Monochrome system: full-bleed horizontal marquee statement + numbered editorial list rows.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via @motionone/solid.

### 4. Architecture / Coverage Map
- A labeled system diagram (SVG, hand-built nodes and edges, not a screenshot) showing the cybersecurity threat-detection platform's core data flow.
- Edges draw in via stroke-dashoffset 1->0 on scroll; nodes fade+scale in staggered by 60ms.
- Every node label ties to real supplied content ({{ITEM_1..6}}) -- no placeholder box labeled "Component".
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for security if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built cybersecurity threat-detection platform product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 127 — Aurora Glassmorphism — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Threat Detection Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to cybersecurity threat-detection platform -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Aurora Glassmorphism system: three desynced radial-gradient blobs + backdrop-blur(24px) glass recipe reused everywhere.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
...
TEMPLATE 128 — Neo-Brutalist Pop — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Threat Detection Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to cybersecurity threat-detection platform -- built in React 18 + TypeScript via Vite state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Neo-Brutalist Pop system: hard offset shadow (8px 8px 0 #111) that flattens to 0 0 0 on press, thick 3px borders on every block.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
...
TEMPLATE 129 — Editorial Serif Luxury — Cybersecurity Threat-Detection Platform
...
TEMPLATE 130 — Dark Technical Console — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
TEMPLATE 131 — Cyberpunk Neon — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
TEMPLATE 132 — Industrial Utilitarian — Cybersecurity Threat-Detection Platform
...
TEMPLATE 133 — Futuristic Chrome — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
TEMPLATE 134 — Soft Minimal Warmth — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
TEMPLATE 135 — Art Deco Revival — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
TEMPLATE 136 — Japanese Minimal (Ma) — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 137 — Scandinavian Functional — Cybersecurity Threat-Detection Platform
...
TEMPLATE 138 — Retro-Futurist 80s — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
TEMPLATE 139 — Y2K Cyber-Cute — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
TEMPLATE 140 — Digital Laboratory — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
TEMPLATE 141 — Terminal-Inspired CLI — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 142 — Financial Terminal Dense — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
TEMPLATE 143 — Magazine Grid — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 144 — High-Fashion Editorial — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 145 — Architectural Blueprint — Cybersecurity Threat-Detection Platform
...
TEMPLATE 146 — Experimental Typography — Cybersecurity Threat-Detection Platform
...
TEMPLATE 147 — Data-Dense Analytics — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
TEMPLATE 148 — Corporate Premium Trust — Cybersecurity Threat-Detection Platform
...
TEMPLATE 149 — Playful Sophisticated — Cybersecurity Threat-Detection Platform
...
TEMPLATE 150 — Organic Earth — Cybersecurity Threat-Detection Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cybersecurity threat-detection platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
TEMPLATE 151 — Swiss Brutalist Monochrome — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to cloud observability / monitoring SaaS -- built in React 18 + TypeScript via Vite state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Swiss Brutalist Monochrome system: full-bleed horizontal marquee statement + numbered editorial list rows.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via D3 (scales, shape, transitions) driving SVG chart elements.

### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, D3 (scales, shape, transitions) driving SVG chart elements.
...
### 6. Architecture
- A labeled system diagram (SVG, hand-built nodes and edges, not a screenshot) showing the cloud observability / monitoring SaaS's core data flow.
- Edges draw in via stroke-dashoffset 1->0 on scroll; nodes fade+scale in staggered by 60ms.
- Every node label ties to real supplied content ({{ITEM_1..6}}) -- no placeholder box labeled "Component".
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for datainfra if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built cloud observability / monitoring SaaS product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 152 — Aurora Glassmorphism — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Live Dashboard Preview
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to cloud observability / monitoring SaaS -- built in Nuxt 3 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Aurora Glassmorphism system: three desynced radial-gradient blobs + backdrop-blur(24px) glass recipe reused everywhere.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via @vueuse/motion.

### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 153 — Neo-Brutalist Pop — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Live Dashboard Preview
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to cloud observability / monitoring SaaS -- built in SolidStart state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Neo-Brutalist Pop system: hard offset shadow (8px 8px 0 #111) that flattens to 0 0 0 on press, thick 3px borders on every block.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via @motionone/solid.

### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 154 — Editorial Serif Luxury — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, D3 (scales, shape, transitions) driving SVG chart elements.
...
TEMPLATE 155 — Dark Technical Console — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 156 — Cyberpunk Neon — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 157 — Industrial Utilitarian — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, D3 (scales, shape, transitions) driving SVG chart elements.
...
TEMPLATE 158 — Futuristic Chrome — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 159 — Soft Minimal Warmth — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 160 — Art Deco Revival — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, D3 (scales, shape, transitions) driving SVG chart elements.
...
TEMPLATE 161 — Japanese Minimal (Ma) — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 162 — Scandinavian Functional — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 163 — Retro-Futurist 80s — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, D3 (scales, shape, transitions) driving SVG chart elements.
...
TEMPLATE 164 — Y2K Cyber-Cute — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 165 — Digital Laboratory — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 166 — Terminal-Inspired CLI — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 167 — Financial Terminal Dense — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 168 — Magazine Grid — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 169 — High-Fashion Editorial — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 170 — Architectural Blueprint — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 171 — Experimental Typography — Cloud Observability / Monitoring Saas
...
TEMPLATE 172 — Data-Dense Analytics — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, D3 (scales, shape, transitions) driving SVG chart elements.
...
TEMPLATE 173 — Corporate Premium Trust — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 174 — Playful Sophisticated — Cloud Observability / Monitoring Saas
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 175 — Organic Earth — Cloud Observability / Monitoring Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a cloud observability / monitoring SaaS ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 4. Metrics Grid
- Grid of {{ITEM_1..6}} (monitoring signals), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, D3 (scales, shape, transitions) driving SVG chart elements.
...
TEMPLATE 176 — Swiss Brutalist Monochrome — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built neobank consumer banking app product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 177 — Aurora Glassmorphism — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 178 — Neo-Brutalist Pop — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 179 — Editorial Serif Luxury — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 180 — Dark Technical Console — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 181 — Cyberpunk Neon — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 182 — Industrial Utilitarian — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 183 — Futuristic Chrome — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 184 — Soft Minimal Warmth — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 185 — Art Deco Revival — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 186 — Japanese Minimal (Ma) — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 187 — Scandinavian Functional — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 188 — Retro-Futurist 80s — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 189 — Y2K Cyber-Cute — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 190 — Digital Laboratory — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 191 — Terminal-Inspired CLI — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 192 — Financial Terminal Dense — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 193 — Magazine Grid — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 194 — High-Fashion Editorial — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 195 — Architectural Blueprint — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 196 — Experimental Typography — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 197 — Data-Dense Analytics — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 198 — Corporate Premium Trust — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 199 — Playful Sophisticated — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: playful sophisticated — bold single accent on cream, hand-tuned micro-illustrations, confident restraint with warmth. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 200 — Organic Earth — Neobank Consumer Banking App

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a neobank consumer banking app ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (account features), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
