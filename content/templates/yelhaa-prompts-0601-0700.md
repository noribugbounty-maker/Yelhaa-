# Yelhaa Generated Prompt Templates 0601–0700

TEMPLATE 601 — Swiss Brutalist Monochrome — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to HR / people-ops platform -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
- No generic startup-template layout — this must read as a purpose-built HR / people-ops platform product, not a page-builder output.
...
TEMPLATE 602 — Aurora Glassmorphism — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 4. Product Surface (Live Mock UI)
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to HR / people-ops platform -- built in React 18 + TypeScript via Vite state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
TEMPLATE 603 — Neo-Brutalist Pop — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
TEMPLATE 604 — Editorial Serif Luxury — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
TEMPLATE 605 — Dark Technical Console — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
TEMPLATE 606 — Cyberpunk Neon — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
TEMPLATE 607 — Industrial Utilitarian — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
TEMPLATE 608 — Futuristic Chrome — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
TEMPLATE 609 — Soft Minimal Warmth — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
TEMPLATE 610 — Art Deco Revival — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
TEMPLATE 611 — Japanese Minimal (Ma) — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 612 — Scandinavian Functional — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 613 — Retro-Futurist 80s — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
TEMPLATE 614 — Y2K Cyber-Cute — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
TEMPLATE 615 — Digital Laboratory — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
TEMPLATE 616 — Terminal-Inspired CLI — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 617 — Financial Terminal Dense — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
TEMPLATE 618 — Magazine Grid — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 619 — High-Fashion Editorial — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 620 — Architectural Blueprint — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 621 — Experimental Typography — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 622 — Data-Dense Analytics — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
TEMPLATE 623 — Corporate Premium Trust — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 624 — Playful Sophisticated — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: playful sophisticated — bold single accent on cream, hand-tuned micro-illustrations, confident restraint with warmth. Production-ready, 100% responsive.
...
TEMPLATE 625 — Organic Earth — Hr / People-Ops Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a HR / people-ops platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
TEMPLATE 626 — Swiss Brutalist Monochrome — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
...
### 6. Case Studies
- Two to four case-study cards from {{CASE_STUDY_1..4}} (client, challenge, result); a result figure is rendered only if it carries a supplied basis -- never invented.
- Card hover: image desaturates -> full color, card lifts translateY(-4px) with a soft shadow, 220ms ease-out.
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for legaltech if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built legal-tech contract automation platform product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 627 — Aurora Glassmorphism — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 628 — Neo-Brutalist Pop — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 629 — Editorial Serif Luxury — Legal-Tech Contract Automation Platform
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 630 — Dark Technical Console — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 631 — Cyberpunk Neon — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 632 — Industrial Utilitarian — Legal-Tech Contract Automation Platform
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 633 — Futuristic Chrome — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 634 — Soft Minimal Warmth — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 635 — Art Deco Revival — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 636 — Japanese Minimal (Ma) — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 637 — Scandinavian Functional — Legal-Tech Contract Automation Platform
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 638 — Retro-Futurist 80s — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 639 — Y2K Cyber-Cute — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 640 — Digital Laboratory — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 641 — Terminal-Inspired CLI — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 642 — Financial Terminal Dense — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 643 — Magazine Grid — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 644 — High-Fashion Editorial — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 645 — Architectural Blueprint — Legal-Tech Contract Automation Platform
...
TEMPLATE 646 — Experimental Typography — Legal-Tech Contract Automation Platform
...
TEMPLATE 647 — Data-Dense Analytics — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 648 — Corporate Premium Trust — Legal-Tech Contract Automation Platform
...
TEMPLATE 649 — Playful Sophisticated — Legal-Tech Contract Automation Platform
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 650 — Organic Earth — Legal-Tech Contract Automation Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a legal-tech contract automation platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (workflow capabilities), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 651 — Swiss Brutalist Monochrome — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Swiss Brutalist Monochrome palette (muted base, accent #0B0B0B pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for realestate if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built commercial real-estate listings platform product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 652 — Aurora Glassmorphism — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Aurora Glassmorphism palette (muted base, accent #6E56F8 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 653 — Neo-Brutalist Pop — Commercial Real-Estate Listings Platform
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Neo-Brutalist Pop palette (muted base, accent #FF4D2E pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 654 — Editorial Serif Luxury — Commercial Real-Estate Listings Platform
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Editorial Serif Luxury palette (muted base, accent #7A2E2E pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 655 — Dark Technical Console — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Dark Technical Console palette (muted base, accent #5EEAD4 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 656 — Cyberpunk Neon — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Cyberpunk Neon palette (muted base, accent #FF2E9A pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 657 — Industrial Utilitarian — Commercial Real-Estate Listings Platform
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Industrial Utilitarian palette (muted base, accent #C9491C pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 658 — Futuristic Chrome — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Futuristic Chrome palette (muted base, accent #7DD3FC pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 659 — Soft Minimal Warmth — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Soft Minimal Warmth palette (muted base, accent #D97757 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 660 — Art Deco Revival — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Art Deco Revival palette (muted base, accent #C9A96A pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 661 — Japanese Minimal (Ma) — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Japanese Minimal (Ma) palette (muted base, accent #C1121F pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 662 — Scandinavian Functional — Commercial Real-Estate Listings Platform
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Scandinavian Functional palette (muted base, accent #3E6259 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 663 — Retro-Futurist 80s — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Retro-Futurist 80s palette (muted base, accent #FF6EC7 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 664 — Y2K Cyber-Cute — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Y2K Cyber-Cute palette (muted base, accent #7C5CFF pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 665 — Digital Laboratory — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Digital Laboratory palette (muted base, accent #2E6FF2 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 666 — Terminal-Inspired CLI — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Terminal-Inspired CLI palette (muted base, accent #39FF14 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 667 — Financial Terminal Dense — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Financial Terminal Dense palette (muted base, accent #00C853 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 668 — Magazine Grid — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Magazine Grid palette (muted base, accent #B0281C pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 669 — High-Fashion Editorial — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching High-Fashion Editorial palette (muted base, accent #FFFFFF pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 670 — Architectural Blueprint — Commercial Real-Estate Listings Platform
...
### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Architectural Blueprint palette (muted base, accent #1B4B91 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 671 — Experimental Typography — Commercial Real-Estate Listings Platform
...
### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Experimental Typography palette (muted base, accent #E8FF59 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 672 — Data-Dense Analytics — Commercial Real-Estate Listings Platform
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Data-Dense Analytics palette (muted base, accent #4C9AFF pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 673 — Corporate Premium Trust — Commercial Real-Estate Listings Platform
...
### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Corporate Premium Trust palette (muted base, accent #0F3D6E pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 674 — Playful Sophisticated — Commercial Real-Estate Listings Platform
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Playful Sophisticated palette (muted base, accent #FF5A36 pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 675 — Organic Earth — Commercial Real-Estate Listings Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a commercial real-estate listings platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (property types), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Organic Earth palette (muted base, accent #5B6E4F pins).
- Marker click flies the camera to the selected property type and opens a side panel with its detail card.
...
TEMPLATE 676 — Swiss Brutalist Monochrome — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.

### 4. Map Explorer
- ('Mapbox GL JS fly-to transitions' if 'Mapbox' in stack['animation'] else 'Interactive map') centered on the supplied region, custom style matching Swiss Brutalist Monochrome palette (muted base, accent #0B0B0B pins).
- Marker click flies the camera to the selected service and opens a side panel with its detail card.
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built residential real-estate brokerage product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 677 — Aurora Glassmorphism — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 678 — Neo-Brutalist Pop — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 679 — Editorial Serif Luxury — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.
...
TEMPLATE 680 — Dark Technical Console — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 681 — Cyberpunk Neon — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 682 — Industrial Utilitarian — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.
...
TEMPLATE 683 — Futuristic Chrome — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 684 — Soft Minimal Warmth — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 685 — Art Deco Revival — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.
...
TEMPLATE 686 — Japanese Minimal (Ma) — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 687 — Scandinavian Functional — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 688 — Retro-Futurist 80s — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.
...
TEMPLATE 689 — Y2K Cyber-Cute — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 690 — Digital Laboratory — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 691 — Terminal-Inspired CLI — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 692 — Financial Terminal Dense — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 693 — Magazine Grid — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 694 — High-Fashion Editorial — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 695 — Architectural Blueprint — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 696 — Experimental Typography — Residential Real-Estate Brokerage
...
TEMPLATE 697 — Data-Dense Analytics — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.
...
TEMPLATE 698 — Corporate Premium Trust — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 699 — Playful Sophisticated — Residential Real-Estate Brokerage
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 700 — Organic Earth — Residential Real-Estate Brokerage

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a residential real-estate brokerage ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 3. Featured Listings
- Grid of {{ITEM_1..6}} (services), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for DOM.
