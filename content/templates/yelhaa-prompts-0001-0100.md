# Yelhaa Generated Prompt Templates 0001–0100

TEMPLATE 001 — Swiss Brutalist Monochrome — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to B2B SaaS analytics dashboard platform -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
- No generic startup-template layout — this must read as a purpose-built B2B SaaS analytics dashboard platform product, not a page-builder output.
...
TEMPLATE 002 — Aurora Glassmorphism — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 4. Product Surface (Live Mock UI)
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to B2B SaaS analytics dashboard platform -- built in React 18 + TypeScript via Vite state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
TEMPLATE 003 — Neo-Brutalist Pop — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
TEMPLATE 004 — Editorial Serif Luxury — B2B Saas Analytics Dashboard Platform
...
TEMPLATE 005 — Dark Technical Console — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
TEMPLATE 006 — Cyberpunk Neon — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
TEMPLATE 007 — Industrial Utilitarian — B2B Saas Analytics Dashboard Platform
...
TEMPLATE 008 — Futuristic Chrome — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
TEMPLATE 009 — Soft Minimal Warmth — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
TEMPLATE 010 — Art Deco Revival — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
TEMPLATE 011 — Japanese Minimal (Ma) — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 012 — Scandinavian Functional — B2B Saas Analytics Dashboard Platform
...
TEMPLATE 013 — Retro-Futurist 80s — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
TEMPLATE 014 — Y2K Cyber-Cute — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
TEMPLATE 015 — Digital Laboratory — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
TEMPLATE 016 — Terminal-Inspired CLI — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 017 — Financial Terminal Dense — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
TEMPLATE 018 — Magazine Grid — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 019 — High-Fashion Editorial — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 020 — Architectural Blueprint — B2B Saas Analytics Dashboard Platform
...
TEMPLATE 021 — Experimental Typography — B2B Saas Analytics Dashboard Platform
...
TEMPLATE 022 — Data-Dense Analytics — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
TEMPLATE 023 — Corporate Premium Trust — B2B Saas Analytics Dashboard Platform
...
TEMPLATE 024 — Playful Sophisticated — B2B Saas Analytics Dashboard Platform
...
TEMPLATE 025 — Organic Earth — B2B Saas Analytics Dashboard Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B SaaS analytics dashboard platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
TEMPLATE 026 — Swiss Brutalist Monochrome — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Live Capability Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to AI writing assistant SaaS -- built in React 18 + TypeScript via Vite state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Swiss Brutalist Monochrome system: full-bleed horizontal marquee statement + numbered editorial list rows.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
...
### 4. Model / Architecture Explainer
- A labeled system diagram (SVG, hand-built nodes and edges, not a screenshot) showing the AI writing assistant SaaS's core data flow.
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for ai if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built AI writing assistant SaaS product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 027 — Aurora Glassmorphism — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Live Capability Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to AI writing assistant SaaS -- built in Qwik City state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Aurora Glassmorphism system: three desynced radial-gradient blobs + backdrop-blur(24px) glass recipe reused everywhere.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via GSAP loaded via useVisibleTask$ only for above-fold.
...
TEMPLATE 028 — Neo-Brutalist Pop — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Live Capability Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to AI writing assistant SaaS -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Neo-Brutalist Pop system: hard offset shadow (8px 8px 0 #111) that flattens to 0 0 0 on press, thick 3px borders on every block.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via Framer Motion (layout + scroll).
...
TEMPLATE 029 — Editorial Serif Luxury — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
TEMPLATE 030 — Dark Technical Console — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
TEMPLATE 031 — Cyberpunk Neon — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
TEMPLATE 032 — Industrial Utilitarian — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
TEMPLATE 033 — Futuristic Chrome — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
TEMPLATE 034 — Soft Minimal Warmth — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
TEMPLATE 035 — Art Deco Revival — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
TEMPLATE 036 — Japanese Minimal (Ma) — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 037 — Scandinavian Functional — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 038 — Retro-Futurist 80s — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
TEMPLATE 039 — Y2K Cyber-Cute — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
TEMPLATE 040 — Digital Laboratory — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
TEMPLATE 041 — Terminal-Inspired CLI — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 042 — Financial Terminal Dense — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
TEMPLATE 043 — Magazine Grid — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 044 — High-Fashion Editorial — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 045 — Architectural Blueprint — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 046 — Experimental Typography — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 047 — Data-Dense Analytics — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
TEMPLATE 048 — Corporate Premium Trust — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 049 — Playful Sophisticated — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: playful sophisticated — bold single accent on cream, hand-tuned micro-illustrations, confident restraint with warmth. Production-ready, 100% responsive.
...
TEMPLATE 050 — Organic Earth — Ai Writing Assistant Saas

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI writing assistant SaaS ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
TEMPLATE 051 — Swiss Brutalist Monochrome — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to AI coding agent / developer copilot -- built in SvelteKit 2 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Swiss Brutalist Monochrome system: full-bleed horizontal marquee statement + numbered editorial list rows.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
...
- A labeled system diagram (SVG, hand-built nodes and edges, not a screenshot) showing the AI coding agent / developer copilot's core data flow.
- Edges draw in via stroke-dashoffset 1->0 on scroll; nodes fade+scale in staggered by 60ms.
- Every node label ties to real supplied content ({{ITEM_1..6}}) -- no placeholder box labeled "Component".

### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built AI coding agent / developer copilot product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 052 — Aurora Glassmorphism — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Code Demo / Terminal
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to AI coding agent / developer copilot -- built in Astro 4 with islands state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Aurora Glassmorphism system: three desynced radial-gradient blobs + backdrop-blur(24px) glass recipe reused everywhere.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 053 — Neo-Brutalist Pop — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Code Demo / Terminal
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to AI coding agent / developer copilot -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Neo-Brutalist Pop system: hard offset shadow (8px 8px 0 #111) that flattens to 0 0 0 on press, thick 3px borders on every block.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 054 — Editorial Serif Luxury — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 055 — Dark Technical Console — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 056 — Cyberpunk Neon — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 057 — Industrial Utilitarian — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 058 — Futuristic Chrome — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 059 — Soft Minimal Warmth — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 060 — Art Deco Revival — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 061 — Japanese Minimal (Ma) — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 062 — Scandinavian Functional — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 063 — Retro-Futurist 80s — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 064 — Y2K Cyber-Cute — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 065 — Digital Laboratory — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 066 — Terminal-Inspired CLI — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 067 — Financial Terminal Dense — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 068 — Magazine Grid — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 069 — High-Fashion Editorial — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 070 — Architectural Blueprint — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 071 — Experimental Typography — Ai Coding Agent / Developer Copilot
...
TEMPLATE 072 — Data-Dense Analytics — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 073 — Corporate Premium Trust — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 074 — Playful Sophisticated — Ai Coding Agent / Developer Copilot
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 075 — Organic Earth — Ai Coding Agent / Developer Copilot

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a AI coding agent / developer copilot ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (agent capabilities), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 076 — Swiss Brutalist Monochrome — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Code Demo / Terminal
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to headless CMS developer platform -- built in Astro 4 with islands state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Swiss Brutalist Monochrome system: full-bleed horizontal marquee statement + numbered editorial list rows.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via GSAP.

### 4. Architecture Diagram
- A labeled system diagram (SVG, hand-built nodes and edges, not a screenshot) showing the headless CMS developer platform's core data flow.
- Edges draw in via stroke-dashoffset 1->0 on scroll; nodes fade+scale in staggered by 60ms.
- Every node label ties to real supplied content ({{ITEM_1..6}}) -- no placeholder box labeled "Component".

### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built headless CMS developer platform product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 077 — Aurora Glassmorphism — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Code Demo / Terminal
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to headless CMS developer platform -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Aurora Glassmorphism system: three desynced radial-gradient blobs + backdrop-blur(24px) glass recipe reused everywhere.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via Framer Motion for chrome.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 078 — Neo-Brutalist Pop — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Code Demo / Terminal
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to headless CMS developer platform -- built in SvelteKit 2 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Neo-Brutalist Pop system: hard offset shadow (8px 8px 0 #111) that flattens to 0 0 0 on press, thick 3px borders on every block.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via Svelte native transitions/motion stores.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 079 — Editorial Serif Luxury — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 080 — Dark Technical Console — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 081 — Cyberpunk Neon — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 082 — Industrial Utilitarian — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 083 — Futuristic Chrome — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 084 — Soft Minimal Warmth — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 085 — Art Deco Revival — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 086 — Japanese Minimal (Ma) — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 087 — Scandinavian Functional — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 088 — Retro-Futurist 80s — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 089 — Y2K Cyber-Cute — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 090 — Digital Laboratory — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 091 — Terminal-Inspired CLI — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 092 — Financial Terminal Dense — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 093 — Magazine Grid — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 094 — High-Fashion Editorial — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 095 — Architectural Blueprint — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 096 — Experimental Typography — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 097 — Data-Dense Analytics — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 098 — Corporate Premium Trust — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 099 — Playful Sophisticated — Headless Cms Developer Platform
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Svelte native transitions/motion stores.
...
TEMPLATE 100 — Organic Earth — Headless Cms Developer Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a headless CMS developer platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 5. Capabilities Grid
- Grid of {{ITEM_1..6}} (API capabilities), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
