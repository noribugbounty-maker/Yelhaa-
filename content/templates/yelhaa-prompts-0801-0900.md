# Yelhaa Generated Prompt Templates 0801–0900

TEMPLATE 801 — Swiss Brutalist Monochrome — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
...
- No generic startup-template layout — this must read as a purpose-built podcast / video media network product, not a page-builder output.
...
TEMPLATE 802 — Aurora Glassmorphism — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 803 — Neo-Brutalist Pop — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 804 — Editorial Serif Luxury — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Alpine.js for micro-interactions.
...
TEMPLATE 805 — Dark Technical Console — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 806 — Cyberpunk Neon — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 807 — Industrial Utilitarian — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Alpine.js for micro-interactions.
...
TEMPLATE 808 — Futuristic Chrome — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 809 — Soft Minimal Warmth — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 810 — Art Deco Revival — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Alpine.js for micro-interactions.
...
TEMPLATE 811 — Japanese Minimal (Ma) — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 812 — Scandinavian Functional — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 813 — Retro-Futurist 80s — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Alpine.js for micro-interactions.
...
TEMPLATE 814 — Y2K Cyber-Cute — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 815 — Digital Laboratory — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 816 — Terminal-Inspired CLI — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 817 — Financial Terminal Dense — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion for chrome.
...
TEMPLATE 818 — Magazine Grid — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 819 — High-Fashion Editorial — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 820 — Architectural Blueprint — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 821 — Experimental Typography — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 822 — Data-Dense Analytics — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Alpine.js for micro-interactions.
...
TEMPLATE 823 — Corporate Premium Trust — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 824 — Playful Sophisticated — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: playful sophisticated — bold single accent on cream, hand-tuned micro-illustrations, confident restraint with warmth. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, GSAP.
...
TEMPLATE 825 — Organic Earth — Podcast / Video Media Network

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a podcast / video media network ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 3. Section Grid
- Grid of {{ITEM_1..6}} (shows), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Alpine.js for micro-interactions.
...
TEMPLATE 826 — Swiss Brutalist Monochrome — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.

### 4. Gameplay Media Gallery
- Grid of {{ITEM_1..6}} (game features), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.

### 5. Community
- Feed or gallery of {{COMMUNITY_ITEM_1..8}} (user-generated or curated); never populated with placeholder avatars presented as real users.

### 6. Wishlist / CTA
- Single-field email/platform capture tied to {{PRIMARY_CTA}}; platform icons (Steam/PS/Xbox-style generic marks) only if the product actually targets that platform.

### 7. Footer
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for gaming if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built indie game studio product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 827 — Aurora Glassmorphism — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 828 — Neo-Brutalist Pop — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Motion One (lightweight WAAPI-backed) for entrances.
...
TEMPLATE 829 — Editorial Serif Luxury — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 830 — Dark Technical Console — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 831 — Cyberpunk Neon — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Motion One (lightweight WAAPI-backed) for entrances.
...
TEMPLATE 832 — Industrial Utilitarian — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 833 — Futuristic Chrome — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 834 — Soft Minimal Warmth — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Motion One (lightweight WAAPI-backed) for entrances.
...
TEMPLATE 835 — Art Deco Revival — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 836 — Japanese Minimal (Ma) — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 837 — Scandinavian Functional — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Motion One (lightweight WAAPI-backed) for entrances.
...
TEMPLATE 838 — Retro-Futurist 80s — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 839 — Y2K Cyber-Cute — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 840 — Digital Laboratory — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Motion One (lightweight WAAPI-backed) for entrances.
...
TEMPLATE 841 — Terminal-Inspired CLI — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 842 — Financial Terminal Dense — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 843 — Magazine Grid — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 844 — High-Fashion Editorial — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 845 — Architectural Blueprint — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 846 — Experimental Typography — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 847 — Data-Dense Analytics — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 848 — Corporate Premium Trust — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 849 — Playful Sophisticated — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: playful sophisticated — bold single accent on cream, hand-tuned micro-illustrations, confident restraint with warmth. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Motion One (lightweight WAAPI-backed) for entrances.
...
TEMPLATE 850 — Organic Earth — Indie Game Studio

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a indie game studio ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 3. Feature Showcase
- Grid of {{ITEM_1..6}} (game features), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 851 — Swiss Brutalist Monochrome — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Measurement / Data Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to climate-tech carbon accounting platform -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via Framer Motion for DOM.
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for climate if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built climate-tech carbon accounting platform product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 852 — Aurora Glassmorphism — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
TEMPLATE 853 — Neo-Brutalist Pop — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.

## TECH STACK
- Framework: React 18 + TypeScript via Vite
- Styling: Tailwind CSS
- Animation: D3 (scales, shape, transitions) driving SVG chart elements, Framer Motion for chrome around charts
- Extra: d3-interpolate for smooth data transitions
- Icons: lucide-react
- Language: TypeScript, strict mode
...
### 3. Measurement / Data Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to climate-tech carbon accounting platform -- built in React 18 + TypeScript via Vite state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
...
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via D3 (scales, shape, transitions) driving SVG chart elements.
...
TEMPLATE 854 — Editorial Serif Luxury — Climate-Tech Carbon Accounting Platform
...
TEMPLATE 855 — Dark Technical Console — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
TEMPLATE 856 — Cyberpunk Neon — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
TEMPLATE 857 — Industrial Utilitarian — Climate-Tech Carbon Accounting Platform
...
TEMPLATE 858 — Futuristic Chrome — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
TEMPLATE 859 — Soft Minimal Warmth — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
TEMPLATE 860 — Art Deco Revival — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
TEMPLATE 861 — Japanese Minimal (Ma) — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 862 — Scandinavian Functional — Climate-Tech Carbon Accounting Platform
...
TEMPLATE 863 — Retro-Futurist 80s — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
TEMPLATE 864 — Y2K Cyber-Cute — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
TEMPLATE 865 — Digital Laboratory — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
TEMPLATE 866 — Terminal-Inspired CLI — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 867 — Financial Terminal Dense — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
TEMPLATE 868 — Magazine Grid — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 869 — High-Fashion Editorial — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 870 — Architectural Blueprint — Climate-Tech Carbon Accounting Platform
...
TEMPLATE 871 — Experimental Typography — Climate-Tech Carbon Accounting Platform
...
TEMPLATE 872 — Data-Dense Analytics — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
TEMPLATE 873 — Corporate Premium Trust — Climate-Tech Carbon Accounting Platform
...
TEMPLATE 874 — Playful Sophisticated — Climate-Tech Carbon Accounting Platform
...
TEMPLATE 875 — Organic Earth — Climate-Tech Carbon Accounting Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a climate-tech carbon accounting platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
TEMPLATE 876 — Swiss Brutalist Monochrome — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Live Canvas Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to creative design tool (figma-like) -- built in SolidStart state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Swiss Brutalist Monochrome system: full-bleed horizontal marquee statement + numbered editorial list rows.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via @motionone/solid.

### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for creative if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built creative design tool (figma-like) product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 877 — Aurora Glassmorphism — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Live Canvas Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to creative design tool (figma-like) -- built in Next.js 15 state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Aurora Glassmorphism system: three desynced radial-gradient blobs + backdrop-blur(24px) glass recipe reused everywhere.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via react-three-fiber.

### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 878 — Neo-Brutalist Pop — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Live Canvas Demo
- STANDARD PATH [REQUIRES: none]: a fully live mock UI relevant to creative design tool (figma-like) -- built in React 18 + TypeScript via Vite state, not a static image. Two or three values update on a 3-4s interval (cleared on unmount) so the surface reads as a working product.
- Frame styled per the Neo-Brutalist Pop system: hard offset shadow (8px 8px 0 #111) that flattens to 0 0 0 on press, thick 3px borders on every block.
- ENHANCED PATH [REQUIRES: 1+ screenshot]: {{HERO_ASSET}} or {{SCREEN_1}} replaces the mock inside the identical frame, same loading/skeleton/error handling.
- SEQUENCE PATH [REQUIRES: 3+ screenshots]: {{SCREEN_1..5}} presented as a pinned, scroll-scrubbed sequence via Custom WebGL shader background (regl or raw GL).

### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 879 — Editorial Serif Luxury — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 880 — Dark Technical Console — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 881 — Cyberpunk Neon — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 882 — Industrial Utilitarian — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 883 — Futuristic Chrome — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 884 — Soft Minimal Warmth — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 885 — Art Deco Revival — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 886 — Japanese Minimal (Ma) — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 887 — Scandinavian Functional — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 888 — Retro-Futurist 80s — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 889 — Y2K Cyber-Cute — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 890 — Digital Laboratory — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 891 — Terminal-Inspired CLI — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 892 — Financial Terminal Dense — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, react-three-fiber.
...
TEMPLATE 893 — Magazine Grid — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 894 — High-Fashion Editorial — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 895 — Architectural Blueprint — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 896 — Experimental Typography — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 897 — Data-Dense Analytics — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
...
TEMPLATE 898 — Corporate Premium Trust — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 899 — Playful Sophisticated — Creative Design Tool (Figma-Like)
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Custom WebGL shader background (regl or raw GL).
...
TEMPLATE 900 — Organic Earth — Creative Design Tool (Figma-Like)

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a creative design tool (figma-like) ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 4. Capabilities Grid
- Grid of {{ITEM_1..6}} (design capabilities), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @motionone/solid.
