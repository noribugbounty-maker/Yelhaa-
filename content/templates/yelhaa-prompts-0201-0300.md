# Yelhaa Generated Prompt Templates 0201–0300

TEMPLATE 201 — Swiss Brutalist Monochrome — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.

## TECH STACK
- Framework: Remix (Vite)
- Styling: vanilla-extract for typed CSS-in-TS design tokens
- Animation: Framer Motion
- Extra: Remix loaders for any dynamic content
- Icons: Lucide React
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
...
### 5. Security
- Certification/compliance marks (SOC2, ISO 27001, GDPR, or category-relevant equivalents) rendered only if supplied via {{CERTIFICATIONS}}; otherwise the section is omitted, never implied.
- For regulated categories: {{REGULATOR}} and {{ENTITY_LEGAL}} rendered as real text in the footer and adjacent to any claim, minimum 13px, 4.5:1 contrast -- never 9px grey fine print.
- No fabricated uptime %, audit dates, or client counts; absent figures render as qualitative statements only.

### 6. Rates / Fees Transparency
...
- Regulatory/legal entity line rendered here for fintech if applicable ({{ENTITY_LEGAL}}).
...
- No generic startup-template layout — this must read as a purpose-built B2B payments / treasury platform product, not a page-builder output.
...
TEMPLATE 202 — Aurora Glassmorphism — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 203 — Neo-Brutalist Pop — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 204 — Editorial Serif Luxury — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 205 — Dark Technical Console — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 206 — Cyberpunk Neon — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 207 — Industrial Utilitarian — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 208 — Futuristic Chrome — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 209 — Soft Minimal Warmth — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 210 — Art Deco Revival — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 211 — Japanese Minimal (Ma) — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 212 — Scandinavian Functional — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 213 — Retro-Futurist 80s — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 214 — Y2K Cyber-Cute — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 215 — Digital Laboratory — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 216 — Terminal-Inspired CLI — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 217 — Financial Terminal Dense — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 218 — Magazine Grid — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 219 — High-Fashion Editorial — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 220 — Architectural Blueprint — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 221 — Experimental Typography — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 222 — Data-Dense Analytics — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 223 — Corporate Premium Trust — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 224 — Playful Sophisticated — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: playful sophisticated — bold single accent on cream, hand-tuned micro-illustrations, confident restraint with warmth. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 225 — Organic Earth — B2B Payments / Treasury Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a B2B payments / treasury platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (payment rails), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 226 — Swiss Brutalist Monochrome — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built wealth management / robo-advisor product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 227 — Aurora Glassmorphism — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 228 — Neo-Brutalist Pop — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 229 — Editorial Serif Luxury — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 230 — Dark Technical Console — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 231 — Cyberpunk Neon — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 232 — Industrial Utilitarian — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 233 — Futuristic Chrome — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 234 — Soft Minimal Warmth — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 235 — Art Deco Revival — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 236 — Japanese Minimal (Ma) — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 237 — Scandinavian Functional — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 238 — Retro-Futurist 80s — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 239 — Y2K Cyber-Cute — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 240 — Digital Laboratory — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 241 — Terminal-Inspired CLI — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 242 — Financial Terminal Dense — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 243 — Magazine Grid — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 244 — High-Fashion Editorial — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 245 — Architectural Blueprint — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
TEMPLATE 246 — Experimental Typography — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
TEMPLATE 247 — Data-Dense Analytics — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 248 — Corporate Premium Trust — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
TEMPLATE 249 — Playful Sophisticated — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: playful sophisticated — bold single accent on cream, hand-tuned micro-illustrations, confident restraint with warmth. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 250 — Organic Earth — Wealth Management / Robo-Advisor

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a wealth management / robo-advisor ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 4. Product Grid
- Grid of {{ITEM_1..6}} (portfolio services), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 251 — Swiss Brutalist Monochrome — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.

## TECH STACK
- Framework: React 18 + TypeScript via Vite
- Styling: Tailwind CSS
- Animation: Custom WebGL shader background (regl or raw GL) + Framer Motion for DOM overlays
- Extra: Shader code-split behind a WebGL-capability check, CSS gradient fallback
- Icons: lucide-react
- Language: TypeScript, strict mode
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #0B0B0B at 15% opacity).
...
### 6. Token / Ecosystem
- Live-style ticker of protocol stats ({{PROOF_STAT_1..4}}) in tabular-nums; every figure requires a supplied basis, never a fabricated APY or TVL.
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for web3 if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built crypto / Web3 trading platform product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 252 — Aurora Glassmorphism — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #6E56F8 at 15% opacity).
...
TEMPLATE 253 — Neo-Brutalist Pop — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #FF4D2E at 15% opacity).
...
TEMPLATE 254 — Editorial Serif Luxury — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: editorial serif luxury — magazine-grade serif display type, generous margins, restrained color, photography-led. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #7A2E2E at 15% opacity).
...
TEMPLATE 255 — Dark Technical Console — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #5EEAD4 at 15% opacity).
...
TEMPLATE 256 — Cyberpunk Neon — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #FF2E9A at 15% opacity).
...
TEMPLATE 257 — Industrial Utilitarian — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: industrial utilitarian — concrete and steel palette, exposed grid lines, stenciled labels, function over decoration. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #C9491C at 15% opacity).
...
TEMPLATE 258 — Futuristic Chrome — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #7DD3FC at 15% opacity).
...
TEMPLATE 259 — Soft Minimal Warmth — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #D97757 at 15% opacity).
...
TEMPLATE 260 — Art Deco Revival — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #C9A96A at 15% opacity).
...
TEMPLATE 261 — Japanese Minimal (Ma) — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #C1121F at 15% opacity).
...
TEMPLATE 262 — Scandinavian Functional — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: scandinavian functional — light wood-neutral palette, clean sans type, function-led hierarchy, quiet confidence. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #3E6259 at 15% opacity).
...
TEMPLATE 263 — Retro-Futurist 80s — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #FF6EC7 at 15% opacity).
...
TEMPLATE 264 — Y2K Cyber-Cute — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #7C5CFF at 15% opacity).
...
TEMPLATE 265 — Digital Laboratory — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #2E6FF2 at 15% opacity).
...
TEMPLATE 266 — Terminal-Inspired CLI — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #39FF14 at 15% opacity).
...
TEMPLATE 267 — Financial Terminal Dense — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #00C853 at 15% opacity).
...
TEMPLATE 268 — Magazine Grid — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #B0281C at 15% opacity).
...
TEMPLATE 269 — High-Fashion Editorial — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #FFFFFF at 15% opacity).
...
TEMPLATE 270 — Architectural Blueprint — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: architectural blueprint — technical drawing aesthetic, thin precise lines, dimension annotations, cool blue-grey. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #1B4B91 at 15% opacity).
...
TEMPLATE 271 — Experimental Typography — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: experimental typography — type as the primary graphic device — variable font weight/width driven by scroll or cursor. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #E8FF59 at 15% opacity).
...
TEMPLATE 272 — Data-Dense Analytics — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #4C9AFF at 15% opacity).
...
TEMPLATE 273 — Corporate Premium Trust — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: corporate premium trust — navy and white, generous whitespace, restrained gold accent, institutional confidence. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #0F3D6E at 15% opacity).
...
TEMPLATE 274 — Playful Sophisticated — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: playful sophisticated — bold single accent on cream, hand-tuned micro-illustrations, confident restraint with warmth. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #FF5A36 at 15% opacity).
...
TEMPLATE 275 — Organic Earth — Crypto / Web3 Trading Platform

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a crypto / Web3 trading platform ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 3. Protocol Stats Ticker
- Ticker row of on-chain metrics from {{PROOF_STAT_1..4}}, monospace tabular-nums, subtle flash animation on value change (150ms background pulse in accent #5B6E4F at 15% opacity).
...
TEMPLATE 276 — Swiss Brutalist Monochrome — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: swiss brutalist monochrome — raw grid discipline, oversized type as the only ornament, zero decorative imagery. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), max 2px, mostly 0 media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
- Multi-column footer: brand + one-line description, product links, company links, legal.
- Bottom bar: 1px top border at #DEDEDA, copyright left, socials right (generic icon marks only).
- Regulatory/legal entity line rendered here for marketplace if applicable ({{ENTITY_LEGAL}}).
...
## STRICT RULES
- No `any` in TypeScript, no non-null assertions.
- No generic startup-template layout — this must read as a purpose-built NFT / on-chain collectibles marketplace product, not a page-builder output.
- Every value shown as fact ({{PROOF_STAT_1..4}}, {{PRICING_TIERS}}, testimonials, case-study results) must trace to a supplied placeholder — never invented.
- Strip every `[REQUIRES: …]` marker and every unselected asset path from the final emitted prompt; the output must read as a single unambiguous specification.
- Mobile-first: every section fully designed at 375px width, not merely stacked from desktop.
```
...
TEMPLATE 277 — Aurora Glassmorphism — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: aurora glassmorphism — deep space backdrop, drifting light fields, frosted translucent surfaces. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 20px on glass surfaces media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 278 — Neo-Brutalist Pop — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: neo-brutalist pop — thick black outlines, flat saturated blocks, deliberately raw hard shadows, no gradients. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 0px everywhere media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
...
TEMPLATE 279 — Editorial Serif Luxury — Nft / On-Chain Collectibles Marketplace
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 0px, hairline rules instead media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 280 — Dark Technical Console — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: dark technical console — near-black canvas, monospace accents, data-dense panels, engineering credibility. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 8px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 281 — Cyberpunk Neon — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: cyberpunk neon — black canvas, saturated magenta/cyan neon, glitch accents, dense HUD framing. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 2px, corner-clipped (clip-path) panels media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 282 — Industrial Utilitarian — Nft / On-Chain Collectibles Marketplace
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 0px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 283 — Futuristic Chrome — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: futuristic chrome — liquid chrome gradients, specular highlights, cool metallic palette, motion-first. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 28px, pill-shaped controls media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 284 — Soft Minimal Warmth — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: soft minimal warmth — warm off-white, generous air, soft shadows, rounded forms, low-contrast restraint. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 24px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 285 — Art Deco Revival — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: art deco revival — gold on deep emerald/black, geometric fan and sunburst motifs, symmetrical ornament. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 0px, chamfered corners via clip-path media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 286 — Japanese Minimal (Ma) — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: japanese minimal (ma) — extreme negative space, single accent stroke, vertical rhythm, quiet confidence. Production-ready, 100% responsive.
...
TEMPLATE 287 — Scandinavian Functional — Nft / On-Chain Collectibles Marketplace
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 12px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 288 — Retro-Futurist 80s — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: retro-futurist 80s — sunset gradient, chrome grid horizon, VHS scanlines, synthwave palette. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 4px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 289 — Y2K Cyber-Cute — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: y2k cyber-cute — chrome bubbles, gradient blobs, glossy buttons, playful maximal energy. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 9999px on buttons, 32px on cards media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 290 — Digital Laboratory — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: digital laboratory — clinical white/blue, precise data grids, diagrammatic annotation lines. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 6px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 291 — Terminal-Inspired CLI — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: terminal-inspired cli — pure monospace, green/amber phosphor accent on black, blinking cursor motifs. Production-ready, 100% responsive.
...
TEMPLATE 292 — Financial Terminal Dense — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: financial terminal dense — black/near-black, tabular-nums everywhere, ticker rows, high information density. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 2px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion (layout + scroll).
...
TEMPLATE 293 — Magazine Grid — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: magazine grid — multi-column editorial grid, drop caps, running heads, varied image sizes. Production-ready, 100% responsive.
...
TEMPLATE 294 — High-Fashion Editorial — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: high-fashion editorial — full-bleed monochrome photography, oversized condensed type, extreme minimalism. Production-ready, 100% responsive.
...
TEMPLATE 295 — Architectural Blueprint — Nft / On-Chain Collectibles Marketplace
...
TEMPLATE 296 — Experimental Typography — Nft / On-Chain Collectibles Marketplace
...
TEMPLATE 297 — Data-Dense Analytics — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: data-dense analytics — tight information density, small multiples, sparkline-everything, muted chart palette. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 10px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
...
TEMPLATE 298 — Corporate Premium Trust — Nft / On-Chain Collectibles Marketplace
...
TEMPLATE 299 — Playful Sophisticated — Nft / On-Chain Collectibles Marketplace
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 18px media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, @vueuse/motion.
...
TEMPLATE 300 — Organic Earth — Nft / On-Chain Collectibles Marketplace

```text
Act as an award-winning Senior UX/UI Designer and Expert Frontend Engineer. Build "{{BRAND_NAME}}", a NFT / on-chain collectibles marketplace ({{PRODUCT_CATEGORY}}). Art direction: organic earth — clay, moss and sand tones, blob/curve shapes, natural texture, calm pacing. Production-ready, 100% responsive.
...
### 3. Browse / Filters
- Grid of {{ITEM_1..6}} (collections), 40% organic blob clip-paths on media media frames; if fewer than 3 items are supplied the grid collapses to a single-column editorial list rather than showing empty slots.
- Hover/focus: media scales 1.0->1.04 over 400ms ease-out, caption slides up from 8px with a 120ms delay.
- Filtering (if {{FILTER_TAXONOMY}} supplied): filter pills update the grid via a FLIP layout transition, Framer Motion.
